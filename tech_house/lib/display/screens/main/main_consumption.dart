    ...
    return Center(
      child: Column(
        children: [
          ...
          const CustomButton(icon: Icons.device_thermostat_outlined, text: 'Temperatura', destination: Options()),
          const SizedBox(height: 15,),
          const CustomButton(icon: Icons.bolt_outlined, text: 'Kilowatts', destination: Options()),
          const SizedBox(height: 15,),
          const CustomButton(icon: Icons.light_mode_outlined, text: 'Luminosidad', destination: Options())
        ],
      ),
    );
  }
